...
export default class FileUploader extends LightningElement {
    @api recordId; // Record Id to which the files are associated
    @track files = []; // List to store files related to the record
    ...
    handleRowAction(event) {
        ...
        if (actionName === 'view') {
            ...
            window.open(`/sfc/servlet.shepherd/version/download/${row.Id}`, );
        }
    }
